        ...
        <styled.FeaturedProject>
          <styled.ProjectContent>
            <div>
              <p className="project-overline">Featured Project</p>
              <h3 className="project-title">
                <Link href="/project/griddy">Griddy</Link>
              </h3>
              <div className="project-description">
                <p>
                  Griddy is a single page application that makes learning CSS
                  grid easy and interactive. I made this project when I finished
                  my first React course on Udemy.
                </p>
              </div>
              <ul className="project-tech-list">
                <li>React</li>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/Halmesn/Griddy"
                  aria-label="GitHub Link"
                  target="_blank"
                >
                  <svg
